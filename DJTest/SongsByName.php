...
$sql="SELECT * FROM CustomLists inner join SongLists on ListName=SongList and SongLists.DJ=CustomLists.DJ WHERE SongLists.DJ = '$dj' AND Active = 'True' Order By SongTitle";
